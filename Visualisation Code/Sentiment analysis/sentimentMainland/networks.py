...
from sentimentMainland.utils import ToolGeneral
from sentimentMainland.hyperparameters import Hyperparams as hp
...
if __name__ =='__main__':
    ...
    s = open(r"weibo-comment.txt", "r", encoding="UTF-8")
    data=s.read()
    print(sa.normalization_score(data))

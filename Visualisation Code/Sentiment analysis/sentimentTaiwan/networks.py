...
from sentimentTaiwan.utils import ToolGeneral
from sentimentTaiwan.hyperparameters import Hyperparams as hp
...
if __name__ =='__main__':
    ...
    s = open(r"taiwan-comment.txt", "r",encoding="UTF-8")
    data=s.read()
